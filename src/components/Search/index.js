...
import { useAllPairsInCarbonPaws, useAllTokensInCarbonPaws } from '../../contexts/GlobalData'
...
export const Search = ({ small = false }) => {
  let allTokens = useAllTokensInCarbonPaws()
  const allTokenData = useAllTokenData()

  let allPairs = useAllPairsInCarbonPaws()
        ...
        <Input
          ...
          placeholder={
            small
              ...
              : 'Search CarbonPaws pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
