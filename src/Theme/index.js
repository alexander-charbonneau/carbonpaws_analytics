...
const theme = (darkMode, color) => ({
  ...
  CarbonPawsPink: darkMode ? '#f2cd00' : 'black',

  concreteGray: darkMode ? '#292C2F' : '#FAFAFA',
  inputBackground: darkMode ? '#1F1F1F' : '#FAFAFA',
  shadowColor: darkMode ? '#000' : '#f2cd00',
  ...
  //primary colors
  primary1: darkMode ? '#f2cd00' : '#f2cd00',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#f2cd00',

  // secondary colors
  secondary1: darkMode ? '#f2cd00' : '#f2cd00',
  secondary2: darkMode ? '#17000b26' : '#F6DDE8',
  secondary3: darkMode ? '#17000b26' : '#FDEAF1',

  shadow1: darkMode ? '#000' : '#f2cd00',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #f2cd00 0%, #fff 0%)`,
})
