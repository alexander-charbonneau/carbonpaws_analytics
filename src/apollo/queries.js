...
export const SUBGRAPH_HEALTH = gql`
  query health {
    indexingStatusForCurrentVersion(subgraphName: "carbonpaws/uniswap") {
      synced
      health
      chains {
        chainHeadBlock {
...
export const V1_DATA_QUERY = gql`
  query CarbonPaws($date: Int!, $date2: Int!) {
    current: CarbonPaws(id: "1") {
      totalVolumeUSD
      totalLiquidityUSD
      txCount
    }
    oneDay: CarbonPawsHistoricalDatas(
    ...
    twoDay: CarbonPawsHistoricalDatas(
